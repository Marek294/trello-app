...
class Board extends Component {
  ...
  boardIsDraggable = value =>
    this.setState({
      isDraggable: value
    });

  handleOnBoardTitleClick = title => () =>
    this.setState({
      isDraggable: false,
      isBoardEditing: true,
      value: title
  ...
  render() {
    ...
    const {
      handleOnBoardDrop,
      tasks,
      handleOnTaskDragStart,
      handleOnTaskDrop,
      handleOnBoardDragStart,
      handleTitleChange,
      board: { title }
    } = this.props;
    ...
    return (
      <div
        ...
        onDragOver={this.onDragOverBoard}
        onDrop={handleOnBoardDrop}
        onDragStart={handleOnBoardDragStart}
      >
        {isBoardEditing ? (
          <React.Fragment>
          ...
          <h3
            ...
            onClick={this.handleOnBoardTitleClick(title)}
          >
            {title}
          </h3>
        )}
